...
BOARD_CPUFREQ_DEFAULT_GOVERNOR := schedutil
BOARD_IOSCHED_DEFAULT := noop
...
BOARD_KERNEL_CMDLINE := \
    ...
    swiotlb=1024 \
    msm_performance.cpu_max_freq_on_battery=1804800 \
    cpu_boost.enable=1 \
    gpu_force_clk_on=1 \
    sched_min_granularity_ns=500000 \
    sched_latency_ns=2000000 \
    sched_migration_fixup=1 \
    idle=halt \
    pm.sleep_mode=1 \
    pm.sleep_mode_platform=1 \
    governor_input_boost_freq=0:1190400 \
    governor_input_boost_ms=40 \
    quiet \
    schedutil.use_energy_aware=1 \
    sched_enable_power_aware=1 \
    androidboot.wakeup_sources_timeout=5000 \
    tcp_low_latency=0 \
